...
namespace Comsec.SqlPrune
{
    ...
    public class PruneConsole : BaseConsole
    {
        ...
        {
            var command = (ICommand) Program.Container.GetInstance(commandType);
        ...
        public int Default()
        {
            ...
            Console.WriteLine("A cli utility to to prune SQL backup files from a given folder (or Amazon S3 bucket).");
            Console.WriteLine();
            ...
            Console.WriteLine();
            Console.WriteLine("             path: The path to a local folder or an S3 bucket containing .bak files (e.g. \"c:\\sql-backups\" or \"s3://bucket-name/backups\")");
            ...
            Console.WriteLine(" -file-extensions: Optional parameter to restrict the file extensions (*.bak by default)");
            Console.WriteLine("      -no-confirm: You will have to confirm before any file is deleted unless this flag is present");
            Console.WriteLine();
            ...
            Console.WriteLine(" -file-extensions: Optional parameter to restrict the file extensions (*.bak by default)");
            Console.WriteLine("      -no-confirm: You will have to confirm before any file is recovered unless this flag is present");
            Console.WriteLine();
